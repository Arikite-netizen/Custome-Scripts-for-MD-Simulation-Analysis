...
# Load the CSV file
file_path = "Sasa.csv"  # Replace with your file path
...
plt.title(
    "Solvent Accessible Surface area of Complex  ",
    fontsize=18,
    weight='bold',
    pad=70  # Increased padding for more space above the legend
)
plt.xlabel("Time(ns)", fontsize=14)
plt.ylabel("Area(nm2)", fontsize=14)
...
plt.savefig("Solvent Accessible Surface area of COMPLEX.png", dpi=300)
plt.show()
